        ...
        <form onSubmit={handleLogin} className="p-4 sm:p-5 space-y-4 overflow-y-auto flex-1">
            ...
            <div className="space-y-1.5 pt-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full text-center text-sm sm:text-base tracking-widest font-mono px-3 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-400"
                  autoFocus
                />
              </div>
              {error && (
          ...
          <div className="pt-3 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-2.5">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto sm:ml-auto">
              ...
              <button
                type="submit"
                className="flex-1 sm:flex-initial px-4 py-2 bg-slate-900 hover:bg-slate-800 dark:bg-slate-100 dark:hover:bg-slate-200 text-white dark:text-slate-900 rounded-xl text-xs font-bold shadow-xs transition-colors cursor-pointer"
              >
                Switch Account
              </button>
            </div>
